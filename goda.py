...
print("Number of characters "+str(len(stringWithNewLine))) # without str() it will not work. Does not mix string and number
...
def returnMultipleValues():
    return 1,3,4
x,y,z = returnMultipleValues() # same number of variables on LHS as the return from a function
